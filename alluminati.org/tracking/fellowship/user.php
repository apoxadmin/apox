...
if(!isset($user))
{
	$list = getUsers(); 
	?>
	<form method="GET" action="/tracking/fellowship/user.php">
...
else
{
	...
	<?php forms_hiddenInput("settrackinguser","/tracking/fellowship/user.php?user=$user");
