<!--something to keep note. I did multiple headers in order to get the main nav to alternate. If you find a better more efficient way, CHANGE IT! it's a lot of code, but it seemed the simplest way for now. -->
...
<!-- Start Footer -->
			...
			<div id="bottom">
				...
				<a href="http://www.iotaphi.org/tracking/mine.php">Normal Site</a> 
				</span>
			</div>
		</div> <!-- end #all div -->
