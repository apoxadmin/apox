...
if ( ! class_exists( 'c2c_RememberMeControls_Plugin_041' ) ) :

abstract class c2c_RememberMeControls_Plugin_041 {
	 ...
	 * @since 036
	 */
	public function __clone() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'remember-me-controls' ), '036' ); }
	 ...
	 * @since 036
	 */
	public function __wakeup() { _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'remember-me-controls' ), '036' ); }
...
//				echo '<div class="hr">&nbsp;</div>' . "\n";
	...
	public function options_page() {
		...
		$c2c = '<a href="http://coffee2code.com" title="coffee2code.com">' . __( 'Scott Reilly, aka coffee2code', 'remember-me-controls' ) . '</a>';
		echo sprintf( __( 'This plugin brought to you by %s.', 'remember-me-controls' ), $c2c );
		echo '<span><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=6ARCFJ9TX3522" title="' . esc_attr__( 'Please consider a donation', 'remember-me-controls' ) . '">' .
		__( 'Did you find this plugin useful?', 'remember-me-controls' ) . '</a></span>';
		echo '</div>' . "\n";
