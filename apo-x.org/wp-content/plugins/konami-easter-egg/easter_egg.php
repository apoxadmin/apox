...
<link rel="stylesheet" href="'; echo get_bloginfo('wpurl'); echo '/wp-content/plugins/konami-easter-egg/css/easter.css" type="text/css" media="screen" /> ';

wp_enqueue_script('easter_egg_jquery', 
get_bloginfo('wpurl') . '/wp-content/plugins/konami-easter-egg/js/jquery.min.js', array(), '1.0', true); 
...
function addwp_easter_content() {
	...
	echo '<p class="easter_credit"><a href=" http://adrian3.com/2009/05/konami-easter-egg_wordpress-plugin/"  onclick="pageTracker._link(this.href); return false;" title="Konami Easter Egg brought to you by Adrian3.com">Konami Easter Egg by Adrian3.com</a></p></div>';
