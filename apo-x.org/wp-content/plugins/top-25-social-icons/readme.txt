...
There is shortcode available <a href="#">check how to use it</a>.
...
1. Go to Widget Section and add Top 25 Social Icons widget  that's it.

if you want to add social icons  in post content or page content, custom fields in latest version shortcode are also there.

Now in latest version there is shortcode functionality as well.

shortcode: [top_25]

Options: 

title:  title of the Social icon for example: if you want to add facebook icon the title value should be facebook.  title="facebook"

image_type:  image you need (available in Top 25 Social Plugins) values are  3Di, circle, circle48, circle64, square48, square, leaf, square, square48

url:  url of social profile  for example:  [top_25 title="facebook" image_type="circle" url="http://facebook.com/"]

new_tab : to open url in new tab add new_tab="yes" 

with shortcode you can call social icons any where in pages, posts, custom fields, meta, text widget

[top_25 title="deviantart" image_type="drops" url="http://deviantart.com"  new_tab="yes"]
