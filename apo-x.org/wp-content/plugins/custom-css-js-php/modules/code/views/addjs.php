...
$form->set_header( __( 'Javascript Code', WCJP_TEXT_DOMAIN ), $response, __( 'Manage CSS', WCJP_TEXT_DOMAIN ), 'wcjp_managecss_code' );
...
$form->add_element( 'textarea', 'data_source', array(
		...
		'desc' => __( 'You can write or paste javascript code here. No need to add &#60;script&#62; tag. Read about <a target="_blank" href="https://codex.wordpress.org/Plugin_API/Action_Reference/wp_head">wp_head</a> and <a target="_blank" href="https://codex.wordpress.org/Plugin_API/Action_Reference/wp_footer">wp_footer</a> ',WCJP_TEXT_DOMAIN ),
		'textarea_rows' => 10,
...
$form->add_element( 'submit', 'save_entity_data', array(
	'value' => __( 'Save JS',WCJP_TEXT_DOMAIN ),
));
