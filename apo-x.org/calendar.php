...
<div  class="row-fluid">
	...
	<div class="span3 visible-desktop">
		<select name="filters" onchange="fill()" class="span8 ">
			...
			<option value="7" <?php echo ($filter==7)?'selected':'' ?>>Family / Active Events</option>
			<option value="9" <?php echo ($filter==9)?'selected':'' ?>>Fundraising</option>
