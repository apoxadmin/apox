...
define('SIGNUP_DAYS', 4); // minimum amount of time before Service events that you can remove yourself without finding a replacement
define('REMOVE_DAYS', 1); // minimum amount of time before Service events that you can sign up

//minimum amount of time before Interviews events needed to sign up/remove
define('INTERVIEWS_SIGNUP_DAYS', 0.5);
define('INTERVIEWS_REMOVE_DAYS', 0.5);
