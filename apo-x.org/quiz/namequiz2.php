...
?>
	...
	while($count-$curCount)
	{
		...
		echo '<a href="#" onclick="return overlib(\'',$name[name],'','','\', STICKY, CAPTION, \'Name\');" onmouseout="return nd();"><img class=\"profile" src="';
			if(file_exists($filename)) {echo $filename;}
			else {echo '/images/profiles/missing.jpg';}
			echo '" title="', $sn[aim] ,'" border=0 /></a>';
		if($curCount%4==3)
			echo '</td></tr>';
		else
			echo '</td>';
